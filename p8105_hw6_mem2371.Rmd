...
There are `r ncol(homicide_df)` variables in this dataset, including city and state, victim age, whether the case was resolved, race and sex. There are `r nrow(homicide_df)` observations, with `r sum(is.na(homicide_df))` missing observations.
